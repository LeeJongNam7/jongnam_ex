...
import 'package:navigator_tabbar_ex_app/model/user.dart';
import 'package:navigator_tabbar_ex_app/view/start.dart';
  ...
  pressButton() {
    if (idController.text.trim().isEmpty ||
        passwordController.text.trim().isEmpty) {
          User.idData = idController.text.trim();
          User.pwData = passwordController.text.trim();
